...
public class Snake_and_ladder_with_all_UC {
	...
	if(p1_score==100) {
		...
		System.out.println("position of the player 1 = " + p1_score);
	}else if(p2_score==100){
		System.out.println("congratulation player 2 won ");
		System.out.println("Position of the player 2 = " + p2_score);	
	}
	if(p1_score<100) {
	System.out.println("Position of player 1 is " + p1_score);
	}
	else if(p2_score<100) {
		System.out.println("Position of player 2 is " + p2_score);
	}
